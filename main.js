...
const DEFAULT_VIDEOS = [
  ...
  { id: "5qap5aO4i9A", title: "Jazz Lofi" },
  { id: "DWcJFNfaw9c", title: "Study Music" },
...
function updateVideoListUI() {
  ...
  if (videoList.length === 0) {
    listContainer.innerHTML = '<div class="text-center text-gray-500 py-4">No videos in list</div>'
    return
  }

  videoList.forEach((video, index) => {
    const videoItem = document.createElement('div')
    videoItem.className = 'flex items-center justify-between p-2 hover:bg-base-300 rounded'
    videoItem.innerHTML = `
